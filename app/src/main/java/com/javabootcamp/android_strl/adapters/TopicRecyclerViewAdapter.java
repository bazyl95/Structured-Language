...
public class TopicRecyclerViewAdapter extends RecyclerView.Adapter<TopicRecyclerViewAdapter.TopicViewHolder> {
    private final static String TAG = TopicRecyclerViewAdapter.class.getSimpleName();
    ...
    public class TopicViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        TopicViewHolder(@NonNull final View itemView, OnTopicListener onTopicListener) {
            super(itemView);
